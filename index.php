        ...
        <div class="row align-items-center">
            <div class="col-lg-6 hero-content">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="<?php echo url('login.php'); ?>" class="btn btn-primary btn-lg px-4 me-md-2">Get Started</a>
                    <a href="#features" class="btn btn-outline-light btn-lg px-4">Learn More</a>
                </div>
            </div>
            <div class="col-lg-6 d-none d-lg-block">
                <img src="<?php echo asset_url('assets/img/hero-img.svg'); ?>" alt="Travel illustration" class="img-fluid">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <a href="<?php echo url('login.php'); ?>" class="btn btn-primary mt-3">Get Started Now</a>
            </div>
            <div class="col-md-6">
                <img src="<?php echo asset_url('assets/img/community.svg'); ?>" alt="Community" class="img-fluid">
            </div>
        </div>
    </div>
</section>
